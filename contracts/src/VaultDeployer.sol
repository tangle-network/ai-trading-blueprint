...
/// @title VaultDeployer
/// @notice Holds TradingVault creation bytecode, keeping VaultFactory under size limits.
/// @dev Called exclusively by VaultFactory to deploy trading vaults via CREATE2.
