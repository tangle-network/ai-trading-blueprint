...
# Audit FIX-2/FIX-3 defaults — satisfy the contract-level floors and tighten
# the spot/TWAP deviation cap from the audit's recommended 500→200 BPS.
# 1800s window > 600s floor (MIN_TWAP_WINDOW); 1e6 harmonic-liquidity > 1000
# floor (MIN_HARMONIC_LIQUIDITY_FLOOR).
UNISWAP_V3_TWAP_WINDOW_SECS="${UNISWAP_V3_TWAP_WINDOW_SECS:-1800}"
UNISWAP_V3_TWAP_MIN_HARMONIC_LIQUIDITY="${UNISWAP_V3_TWAP_MIN_HARMONIC_LIQUIDITY:-1000000}"
UNISWAP_V3_TWAP_MAX_SPOT_DEVIATION_BPS="${UNISWAP_V3_TWAP_MAX_SPOT_DEVIATION_BPS:-200}"
UNISWAP_V3_TWAP_FEE_TIERS="${UNISWAP_V3_TWAP_FEE_TIERS:-500,3000,10000}"
UNISWAP_V3_TWAP_OWNER="${UNISWAP_V3_TWAP_OWNER:-$OPERATOR_ONE}"
...
UNISWAP_V3_TWAP_VALUATOR="$(deploy_contract "$ROOT_DIR/contracts/out/UniswapV3TwapValuator.sol/UniswapV3TwapValuator.json" "constructor(address,address,uint32,uint128,uint32)" "$UNISWAP_V3_TWAP_OWNER" "$UNISWAP_V3_FACTORY" "$UNISWAP_V3_TWAP_WINDOW_SECS" "$UNISWAP_V3_TWAP_MIN_HARMONIC_LIQUIDITY" "$UNISWAP_V3_TWAP_MAX_SPOT_DEVIATION_BPS")"
...
EXECUTION_UNISWAP_V3_TWAP_VALUATOR=$UNISWAP_V3_TWAP_VALUATOR
EXECUTION_UNISWAP_V3_TWAP_OWNER=$UNISWAP_V3_TWAP_OWNER
EXECUTION_UNISWAP_V3_TWAP_WINDOW_SECS=$UNISWAP_V3_TWAP_WINDOW_SECS
EXECUTION_UNISWAP_V3_TWAP_MIN_HARMONIC_LIQUIDITY=$UNISWAP_V3_TWAP_MIN_HARMONIC_LIQUIDITY
EXECUTION_UNISWAP_V3_TWAP_MAX_SPOT_DEVIATION_BPS=$UNISWAP_V3_TWAP_MAX_SPOT_DEVIATION_BPS
EXECUTION_UNISWAP_V3_TWAP_FEE_TIERS=$UNISWAP_V3_TWAP_FEE_TIERS
EXECUTION_WRAPPED_ASSET_VALUATOR=$WRAPPED_ASSET_VALUATOR
CHAINLINK_USD_VALUATOR_ADDRESS=$CHAINLINK_USD_VALUATOR
UNISWAP_V3_TWAP_VALUATOR_ADDRESS=$UNISWAP_V3_TWAP_VALUATOR
UNISWAP_V3_TWAP_OWNER=$UNISWAP_V3_TWAP_OWNER
UNISWAP_V3_TWAP_WINDOW_SECS=$UNISWAP_V3_TWAP_WINDOW_SECS
UNISWAP_V3_TWAP_MIN_HARMONIC_LIQUIDITY=$UNISWAP_V3_TWAP_MIN_HARMONIC_LIQUIDITY
UNISWAP_V3_TWAP_MAX_SPOT_DEVIATION_BPS=$UNISWAP_V3_TWAP_MAX_SPOT_DEVIATION_BPS
UNISWAP_V3_TWAP_FEE_TIERS=$UNISWAP_V3_TWAP_FEE_TIERS
...
echo "  TWAP val:        $UNISWAP_V3_TWAP_VALUATOR"
