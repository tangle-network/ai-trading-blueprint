...
# TWAP defaults that satisfy the contract-level floors:
#   1800s window  > 600s   (MIN_TWAP_WINDOW)
#   1e6 harmonic  > 1000   (MIN_HARMONIC_LIQUIDITY_FLOOR)
#   200 BPS deviation cap  (tighter than the contract's 10000 BPS ceiling)
