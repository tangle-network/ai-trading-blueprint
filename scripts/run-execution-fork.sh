...
UNISWAP_V3_TWAP_MIN_HARMONIC_LIQUIDITY="${UNISWAP_V3_TWAP_MIN_HARMONIC_LIQUIDITY:-1}"
UNISWAP_V3_TWAP_MAX_SPOT_DEVIATION_BPS="${UNISWAP_V3_TWAP_MAX_SPOT_DEVIATION_BPS:-500}"
