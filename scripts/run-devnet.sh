...
USDC_ADDRESS="$(grep '^VITE_USDC_ADDRESS=' "$ROOT_DIR/arena/.env.local" | cut -d= -f2)"
WETH_ADDRESS="$(grep '^VITE_WETH_ADDRESS=' "$ROOT_DIR/arena/.env.local" | cut -d= -f2)"
...
ASSET_TOKEN_ADDRESS="$USDC_ADDRESS" \
