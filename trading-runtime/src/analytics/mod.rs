...
/// only need a uniform `usize`-indexing source; `rand`'s feature surface
/// (entropy sources, distribution types) is overkill. Period 2^64 - 1 —
/// fine for sample sizes ≤ 10^6 we'll ever hand it.
