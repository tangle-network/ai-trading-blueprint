...
pub fn build_instance_router() -> Router {
    Router::new()
        ...
        .route("/api/bot/chart/studies", get(get_bot_chart_studies))
    ...
    match payload {
        ...
        serde_json::Value::Object(mut map) => {
            ...
            map.entry("limit".to_string())
                .or_insert_with(|| serde_json::json!(query.limit.unwrap_or(50).min(200)));
            map.entry("offset".to_string())
                .or_insert_with(|| serde_json::json!(query.offset.unwrap_or(0)));
