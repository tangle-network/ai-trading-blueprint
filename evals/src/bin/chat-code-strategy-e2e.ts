...
import { runChatCodeStrategyE2E } from '../product/chat-code-strategy-runner.js'
...
const options: Parameters<typeof runChatCodeStrategyE2E>[0] = {
...
const scenarios = valuesAfter('--scenario')
if (scenarios.length > 0) options.scenarioIds = scenarios

const report = await runChatCodeStrategyE2E(options)
