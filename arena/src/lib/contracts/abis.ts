...
export const tradingVaultAbi = [
  ...
  { type: 'function', name: 'idleAssets', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'hyperliquidAccountAssets', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  ...
  { type: 'function', name: 'isNavSafe', inputs: [], outputs: [{ name: '', type: 'bool' }], stateMutability: 'view' },
  ...
  { type: 'function', name: 'previewRedeemInKind', inputs: [{ name: 'shares', type: 'uint256' }], outputs: [{ name: 'tokens', type: 'address[]' }, { name: 'amounts', type: 'uint256[]' }], stateMutability: 'view' },
  ...
  { type: 'function', name: 'requestRedeem', inputs: [{ name: 'shares', type: 'uint256' }, { name: 'receiver', type: 'address' }, { name: 'owner_', type: 'address' }], outputs: [{ name: 'requestId', type: 'uint256' }], stateMutability: 'nonpayable' },
  { type: 'function', name: 'cancelRedeem', inputs: [{ name: 'requestId', type: 'uint256' }], outputs: [{ name: 'shares', type: 'uint256' }], stateMutability: 'nonpayable' },
  ...
  { type: 'function', name: 'ACTION_KIND_HYPERLIQUID_FUND_MOVEMENT', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'HYPERLIQUID_ACTION_SPOT_SEND', inputs: [], outputs: [{ name: '', type: 'uint24' }], stateMutability: 'view' },
  { type: 'function', name: 'HYPERLIQUID_ACTION_USD_CLASS_TRANSFER', inputs: [], outputs: [{ name: '', type: 'uint24' }], stateMutability: 'view' },
  { type: 'function', name: 'HYPERLIQUID_FUND_MOVEMENT_TYPEHASH', inputs: [], outputs: [{ name: '', type: 'bytes32' }], stateMutability: 'view' },
  { type: 'function', name: 'HYPERLIQUID_FUND_MOVEMENT_EXECUTION_TYPEHASH', inputs: [], outputs: [{ name: '', type: 'bytes32' }], stateMutability: 'view' },
  { type: 'function', name: 'fundMovementNonceUsed', inputs: [{ name: 'nonce', type: 'uint256' }], outputs: [{ name: 'used', type: 'bool' }], stateMutability: 'view' },
  { type: 'function', name: 'leverageCap', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'maxTradesPerHour', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'maxSlippageBps', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'computeFundMovementHashes', inputs: [{ name: 'actionType', type: 'uint24' }, { name: 'destination', type: 'address' }, { name: 'token', type: 'uint64' }, { name: 'amount', type: 'uint64' }, { name: 'direction', type: 'bool' }, { name: 'nonce', type: 'uint256' }, { name: 'deadline', type: 'uint256' }, { name: 'action', type: 'bytes' }], outputs: [{ name: 'intentHash', type: 'bytes32' }, { name: 'executionHash', type: 'bytes32' }], stateMutability: 'view' },
  ...
  { type: 'function', name: 'returnUsdClassLiquidity', inputs: [{ name: 'ntl', type: 'uint64' }, { name: 'toPerp', type: 'bool' }, { name: 'authorization', type: 'tuple', components: [{ name: 'nonce', type: 'uint256' }, { name: 'deadline', type: 'uint256' }, { name: 'signatures', type: 'bytes[]' }, { name: 'scores', type: 'uint256[]' }] }], outputs: [], stateMutability: 'nonpayable' },
  ...
  { type: 'function', name: 'returnSpotLiquidity', inputs: [{ name: 'destination', type: 'address' }, { name: 'token', type: 'uint64' }, { name: 'weiAmount', type: 'uint64' }, { name: 'authorization', type: 'tuple', components: [{ name: 'nonce', type: 'uint256' }, { name: 'deadline', type: 'uint256' }, { name: 'signatures', type: 'bytes[]' }, { name: 'scores', type: 'uint256[]' }] }], outputs: [], stateMutability: 'nonpayable' },
  ...
  { type: 'event', name: 'HyperliquidFundMovementAuthorized', inputs: [{ name: 'actionType', type: 'uint24', indexed: true }, { name: 'nonce', type: 'uint256', indexed: true }, { name: 'intentHash', type: 'bytes32', indexed: false }, { name: 'executionHash', type: 'bytes32', indexed: false }], anonymous: false },
  ...
  { type: 'event', name: 'InKindRedeemed', inputs: [{ name: 'caller', type: 'address', indexed: true }, { name: 'receiver', type: 'address', indexed: true }, { name: 'owner', type: 'address', indexed: true }, { name: 'shares', type: 'uint256', indexed: false }], anonymous: false },
